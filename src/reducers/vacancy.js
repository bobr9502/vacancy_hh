...
export function getVacancy(state)
{
	...
	if (sortVacancy==="Название")
		vacancyFilterSort = vacancyFilterSort.sort(compareName)
	else if (sortVacancy==="Зарплата от")
		vacancyFilterSort = vacancyFilterSort.sort(compareSalaryFrom)
	else if (sortVacancy==="Зарплата до")
		vacancyFilterSort = vacancyFilterSort.sort(compareSalaryTo)
